...
# def timeout_handler():
#     time_count = 0
#     while time_count < time_limit_per_turn:
#         sleep(1)
#         time_count += 1
#         print(time_count)
#     print(f"Timeout: {time_limit_per_turn}")
...
while game_continue:
    ...
    # randomly choose word from words list
    ...
    while wrong_attempts < 7:
        ...
        # thread_timeout.join()
        # convert guess to lowe case
        guess = guess.lower()
        # Checking the guessed letter if in choosen word
        if guess in choosen_word and timeout_indicator == False:
